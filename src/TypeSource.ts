...
import { type JSONSchemaSourceData, type JSONSourceData } from "@novonotes/quicktype-core";
import { type GraphQLSourceData } from "@novonotes/quicktype-graphql-input";
